...
virtual void display()=0;//do nothing function -->Pure virtual function.The use of pure virtual function is we must display function 
//in every inherit derived class otherwise it displays an error. The base class in which minimum one pure function is defined
//this class is called abstract base class.
};
